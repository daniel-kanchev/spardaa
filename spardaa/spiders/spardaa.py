...
from spardaa.items import Article


class SpardaaSpider(scrapy.Spider):
    name = 'spardaa'
    start_urls = [
        'https://www.sparda-a.de/nachrichten-presse-nachrichten-pressemitteilungen/nachrichten-pressemitteilungen.html']
